<?php 
$order = htmlspecialchars($_GET["number"]);
?>
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "order-info.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/order-info.css?crc=4192774797" id="pagesheet"/>
    <!--HTML Widget code-->
...
<div class='mf-menu'>
  ...
  <div class='menuContent'>
   ...
   <div class="colelem" id="u457"><!-- content --></div>
   <div class="verticalspacer" data-offset-top="215" data-content-above-spacer="250" data-content-below-spacer="249">
  ...
  <table class="w3-table-all w3-hoverable">
    ...
    $sql = "SELECT * FROM orders_items WHERE number = '".$order."' ";
