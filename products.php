...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "products.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/products.css?crc=187089625" id="pagesheet"/>
    <!--HTML Widget code-->
...
<div class='mf-menu'>
  ...
  <div class='menuContent'>
    <ul>
            ...
            <li class="lineClass"><a class="linkClass" href="products.php">Products</a></li>
   ...
   <div class="colelem" id="u439"><!-- content --></div>
   <div class="verticalspacer" data-offset-top="243" data-content-above-spacer="269" data-content-below-spacer="231">
  ...
  <table class="w3-table-all w3-hoverable">
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            $productimage = "images/products/" . $row["image"];
            echo "<tr><td>" . $row["pid"]. '</td><td><img src="'. $productimage .'" width="100" height="100"></td>' . "<td> Tsh " . $row["price"]. "</td><td>" . $row["stock"] ."</td><td>" . $row["location"]. "</td></tr>";
        }
    } else {
        echo "0 results";
    }
